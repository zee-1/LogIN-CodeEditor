...
log = RoundedButton(frame_bg_l,30,30,15,0,None,"#2F6997",logIn,logger)
log.grid(row=3, column=0, sticky=W)

reg = PhotoImage(file='img/register-1.png')


temp_but = RoundedButton(frame_bg_l,120,30,15,0,None,"#2F6997",lambda: Regist(main_win),image=reg)
temp_but.grid(row=4,column=1,sticky=W)

qt = PhotoImage(file="img/quit.png")
quit_r = RoundedButton(frame_bg_l,30,30,15,0,None,"#2F6997",lambda: main_win.destroy(),qt)
